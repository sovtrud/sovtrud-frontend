...
export default function IconsContainer() {
    return (
        <div className="iconsContainer">
            ...
            <IconWithSvg children={WorkFocusNormal} status="not_active" size={SvgSize.BASE24}/>
            <IconWithSvg children={WorkFocusNormal} status="not_active" size={SvgSize.BASE30}/>
            <IconWithSvg children={WorkFocus} status="active" size={SvgSize.BASE24}/>
            <IconWithSvg children={WorkHistory} status="active" size={SvgSize.BASE30}/>
            <IconWithSvg children={WorkHistory} status="normal" size={SvgSize.BASE30}/>
            <IconWithSvg children={WorkHistory} status="normal" size={SvgSize.BASE24}/>
            <IconWithSvg children={WorkHistory} status="active" size={SvgSize.BASE24}/>
            ...
            <IconWithSvg children={ArrowRight} status="active" size={SvgSize.BASE24}/>
            ...
            <IconWithSvg children={PlusCircle} status="active" size={SvgSize.BASE24}/>
            ...
            <IconWithSvg children={DeleteForever} status="active" size={SvgSize.BASE24}/>
            ...
            <IconWithSvg children={FilterVariant} status="active" size={SvgSize.BASE24}/>
            <IconWithSvg children={CheckboxMultiple} status="active" size={SvgSize.BASE24}/>
            <IconMenu />
            <ExclamationMark />
            <Fire />
